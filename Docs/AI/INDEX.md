...
| Chop Editor design and tests | [Chop Editor](CHOP-EDITOR.md) | Rolling boundaries, raw preview, state and limitations |
...
| User Chop Editor workflow | [Chop Editor guide](../../SMS-Midichopper/Docs/CHOP-EDITOR.md) | Raw boundary editing and Apply/Revert behavior |
