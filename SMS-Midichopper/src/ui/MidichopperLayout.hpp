...
inline constexpr unsigned int canvasHeight = 760U;
inline constexpr unsigned int minimumWidth = 765U;
inline constexpr unsigned int minimumHeight = 560U;
...
inline constexpr sms::ui::Rect outputMeter{1008.0f, 96.0f, 24.0f, 590.0f};

inline constexpr sms::ui::Rect mainPanel{24.0f, 96.0f, 630.0f, 596.0f};
inline constexpr sms::ui::Rect sidePanel{670.0f, 96.0f, 266.0f, 596.0f};
...
inline constexpr sms::ui::Rect mainPadBounds{46.0f, 196.0f, 586.0f, 470.0f};
...
inline constexpr sms::ui::Rect envelopeGraph{46.0f, 448.0f, 250.0f, 104.0f};
inline constexpr sms::ui::Rect editorPadBounds{690.0f, 204.0f, 222.0f, 406.0f};
inline constexpr sms::ui::Rect playOnSelect{690.0f, 628.0f, 222.0f, 34.0f};
...
inline constexpr sms::ui::Rect oneShotMode{690.0f, 220.0f, 106.0f, 38.0f};
inline constexpr sms::ui::Rect gatedMode{804.0f, 220.0f, 108.0f, 38.0f};
inline constexpr sms::ui::Rect voiceLimit{690.0f, 298.0f, 222.0f, 28.0f};
...
inline constexpr sms::ui::Rect monitor{690.0f, 646.0f, 222.0f, 34.0f};
inline constexpr float globalMixerLabelY = 500.0f;
inline constexpr float chopLabelY = 382.0f;
inline constexpr sms::ui::Rect finalizeAction{690.0f, 402.0f, 70.0f, 34.0f};
inline constexpr sms::ui::Rect undoAction{766.0f, 402.0f, 70.0f, 34.0f};
inline constexpr sms::ui::Rect clearAction{842.0f, 402.0f, 70.0f, 34.0f};
...
{
    return {330.0f, 438.0f + static_cast<float>(index) * 29.0f, 280.0f, 24.0f};
}
