...
std::string encodePlaybackSettings(const sms::dsp::SamplePlaybackSettings& requested)
{
    return sms::state::encodeSamplePlaybackSettings(requested);
}

bool decodePlaybackSettings(const char* const encoded,
